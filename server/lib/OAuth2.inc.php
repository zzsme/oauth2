...
abstract class OAuth2 {
   ...
   */
  abstract protected function setAccessToken($oauth_token, $client_id, $expires, $uid, $scope = NULL);
  ...
  protected function createAccessToken($client_id, $uid, $scope = NULL) {
    ...
    $this->setAccessToken($token["access_token"], $client_id, time() + $this->getVariable('access_token_lifetime', OAUTH2_DEFAULT_ACCESS_TOKEN_LIFETIME), $uid, $scope);
